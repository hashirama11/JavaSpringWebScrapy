...
public class FarmatodoService {
    ...
    final private DjangoDRFService djangoService;
    
    public FarmatodoService(DjangoDRFService djangoService, FarmatodoRepository farmatodoRepository) {
    ...
    public List<ScrapyWebFarmatodo> existenciaPorNombre(String nombre) {
        ...
        if (productos.isEmpty()) {
            ...
            djangoService.enviarNombreProducto(nombre, FarmaEnum.FARMATODO);
