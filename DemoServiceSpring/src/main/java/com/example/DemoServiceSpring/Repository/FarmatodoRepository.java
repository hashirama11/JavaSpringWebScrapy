...
@Repository
public interface FarmatodoRepository extends JpaRepository<ScrapyWebFarmatodo, Long> {
    ...
    List<ScrapyWebFarmatodo> findByNombreContaining(String nombre);
    ...
    List<ScrapyWebFarmatodo> buscarPorNombreSimilar(@Param("nombre") String nombre);
